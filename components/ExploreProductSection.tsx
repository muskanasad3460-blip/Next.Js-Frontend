...
export default function ExploreProductSection() {
  ...
  return (
    <section className="w-full">
      {/* FIXED CONTAINER (matches other sections) */}
      <div className="max-w-6xl mx-auto px-6 md:px-10 py-16">
        ...
        >
          {products.map((product) => (
            <div key={product.id} className="w-[270] shrink-0">
              <div className="relative bg-[#F5F5F5] rounded-md h-[260] flex items-center justify-center overflow-hidden group">
                {/* Badge */}
                {product.badge && (
